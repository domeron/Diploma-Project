    ...
    return (
        ...
        <div className="bg-slate-50">
            <div className='mx-auto max-w-5xl mb-16'>
                ...
                className="mt-8 mb-4 group flex gap-4 items-center cursor-pointer">
...
function SuccessPage({orderId, paymentTime, products}) {
    ...
    return (
        <div className="py-6 flex flex-col items-center">
            ...
            <div className="p-4 w-1/3 border border-gray-300 rounded">
                <p className="mb-4 text-lg font-semibold">Payment Details:</p>
                <div className="py-4 flex flex-col gap-2 border-t-2 border-dashed border-gray-300 ">
